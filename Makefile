...
build: check-docker
	...
	@$(ENGINE_CMD) build -t localhost/soulscout/healthcheck:latest -f ops/healthcheck.dockerfile .
	@$(ENGINE_CMD) build -t localhost/soulscout/tg_gateway:latest -f ../tg_gateway/tg_gateway.dockerfile ../tg_gateway
	@$(ENGINE_CMD) build -t localhost/soulscout/portfolio:latest -f ../portfolio/portfolio.dockerfile ../portfolio
	@$(ENGINE_CMD) build -t localhost/soulscout/ingestor:latest -f ../ingestor/ingestor.dockerfile ../ingestor
	@$(ENGINE_CMD) build -t localhost/soulscout/analytics:latest -f ../analytics/analytics.dockerfile ../analytics
	@$(ENGINE_CMD) build -t localhost/soulscout/notifier:latest -f ../notifier/notifier.dockerfile ../notifier
